#!/usr/bin/env node
/**
 * Seed reviewPage-image-review in Sanity, including the two per-feature
...
async function main() {
  ...
  const card1Image = await uploadAsset(`${fcReview}/c1-hero.png`);
  ...
  const doc = {
    _id: "reviewPage-image-review",
    _type: "reviewPage",
    title: "Image Review",
    slug: { _type: "slug", current: "image-review" },
    feature: "image",
    hero: {
      headlineLine1: "Ship Image Assets",
      subheading: "Get approved with fewer rounds of reviews. Get back to creating.",
      personaLeft: { label: "Photographer", color: "#3DB7E4" },
    ...
    faqFormatsAnswer: "PNG, JPG, GIF, WebP, AVIF, SVG, TIFF and HEIC.",
    metaTitle: "Image Review — Superflow by Velt",
    metaDescription:
      "Ship image assets impossibly fast. Comment, prioritise, approve and sync image reviews with your existing tools.",
  };

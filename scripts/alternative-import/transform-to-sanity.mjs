#!/usr/bin/env node
/**
 * Transform Framer Alternative raw JSON → Sanity alternativePage shape.
 *
 * Input:  scripts/alternative-import/framer-alt-raw.json
 * Output: scripts/alternative-import/framer-alt-sanity.json
 *
...
const raw = JSON.parse(readFileSync(here("framer-alt-raw.json"), "utf8"));
...
writeFileSync(here("framer-alt-sanity.json"), JSON.stringify(docs, null, 2));
console.log(`Wrote ${docs.length} docs → framer-alt-sanity.json`);

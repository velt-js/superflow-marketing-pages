#!/usr/bin/env node
/**
 * Seed reviewPage-lottie-files-review in Sanity, including the two per-feature
...
async function main() {
  ...
  const card1Image = await uploadAsset(`${fcReview}/c1-lottie.png`);
  ...
  const collab = [
    {
      ...
      preview: `${cFig}/preview-1-lottie.png`,
    },
    {
  ...
  const doc = {
    _id: "reviewPage-lottie-files-review",
    _type: "reviewPage",
    title: "Lottie Review",
    slug: { _type: "slug", current: "lottie-files-review" },
    feature: "lottie",
    hero: {
      headlineLine1: "Ship Lottie Animations",
      subheading: "Get approved with fewer rounds of reviews. Get back to creating.",
      personaLeft: { label: "Animator", color: "#3DB7E4" },
    ...
    faqFormatsAnswer: "Lottie JSON, dotLottie and animated SVG.",
    metaTitle: "Lottie Review — Superflow by Velt",
    metaDescription:
      "Ship Lottie animations impossibly fast. Comment, prioritise, approve and sync animation reviews with your existing tools.",
  };

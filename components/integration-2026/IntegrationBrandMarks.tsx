...
/**
 * The Shopify mark — the green shopping bag with the white "S" (geometry
 * from public/images/home-2026/integrations/shopify.svg, the shared logo
 * asset; viewBox cropped to the artwork).
 *
 * @param props - Rendered size and optional class name.
 * @returns The inline Shopify SVG, or `null` on failure.
 */
    ...
    return (
      ...
      >
        <path
          ...
          clipRule="evenodd"
          fill="#95BF47"
          d="M40.8653 52.523L40.7744 17.8407C40.5389 17.6071 40.0796 17.6776 39.9 17.7297L38.7039 18.0974C38.5563 17.6155 38.3647 17.1479 38.1315 16.7004C37.2828 15.0929 36.0424 14.2429 34.5409 14.2406H34.5362C34.436 14.2406 34.3369 14.2499 34.2366 14.258L34.225 14.2591C34.1816 14.2061 34.1365 14.1544 34.0897 14.1041C33.4369 13.4103 32.5975 13.0714 31.5926 13.1003C29.6551 13.1558 27.7257 14.5459 26.16 17.015C25.0584 18.7531 24.2225 20.9354 23.9835 22.625L20.1679 23.7988C19.0452 24.1492 19.0103 24.1839 18.8622 25.2351C18.7515 26.0307 15.8125 48.6037 15.8125 48.6037L40.4433 52.8341L40.8653 52.523ZM32.7957 14.6858C32.4681 14.4719 32.0846 14.3724 31.6299 14.3817C28.6385 14.4673 26.0295 19.1082 25.3638 22.2005L28.2293 21.3193L28.7411 21.162C29.1165 19.1984 30.0584 17.1607 31.2907 15.8492C31.7215 15.3793 32.2301 14.9859 32.7945 14.6858H32.7957ZM30.1575 20.7261L34.2704 19.4609C34.2833 18.3969 34.1667 16.8241 33.6304 15.7139C33.0592 15.9475 32.5789 16.3569 32.2338 16.7235C31.3093 17.71 30.5551 19.2146 30.1587 20.7261H30.1575ZM35.5586 19.0654L37.4705 18.4767C37.1651 17.4914 36.44 15.84 34.9699 15.5624C35.4269 16.7339 35.5446 18.0905 35.5586 19.0654Z"
        />
        <path
          fill="#5E8E3E"
          d="M46.3901 20.42C46.2432 20.4084 43.3963 20.3645 43.3963 20.3645C43.3963 20.3645 41.0146 18.0677 40.7791 17.833C40.688 17.7495 40.5725 17.6968 40.4492 17.6826V52.8275L51.122 50.1919C51.122 50.1919 46.7666 20.9438 46.7387 20.7438C46.7252 20.6588 46.6834 20.5808 46.62 20.5221C46.5567 20.4634 46.4765 20.4274 46.39 20.42Z"
        />
        <path
          fill="#ffffff"
          d="M34.5283 25.8778L33.2879 30.4852C33.2879 30.4852 31.9053 29.8595 30.2651 29.9625C27.8612 30.1128 27.8356 31.6197 27.86 31.9978C27.9906 34.0564 33.4477 34.5074 33.7543 39.3333C33.9956 43.13 31.727 45.7285 28.4581 45.9321C24.5352 46.1784 22.375 43.8793 22.375 43.8793L23.2062 40.366C23.2062 40.366 25.3804 41.9955 27.1198 41.8856C28.2576 41.8151 28.6633 40.8968 28.6225 40.2469C28.4511 37.5604 24.0071 37.7177 23.7261 33.3023C23.4907 29.5843 25.947 25.82 31.3691 25.48C33.4582 25.3482 34.5283 25.879 34.5283 25.879"
        />
      </svg>
    );
  } catch {

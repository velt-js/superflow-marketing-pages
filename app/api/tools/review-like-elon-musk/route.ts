...
const TOOL_SLUG = "review-like-elon-musk";

/** The free-tool id, which is also the backend agent id. */
const BACKEND_TOOL_ID = "review-like-elon-musk";
...
export async function POST(request: NextRequest): Promise<Response> {
  return runPersonaReview({
    ...
    notConfiguredMessage:
      "The Elon Musk review is not available right now. Try again in a moment.",
  });
}

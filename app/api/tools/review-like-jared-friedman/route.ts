...
const TOOL_SLUG = "review-like-jared-friedman";

/** The free-tool id, which is also the backend agent id. */
const BACKEND_TOOL_ID = "review-like-jared-friedman";
...
export async function POST(request: NextRequest): Promise<Response> {
  return runPersonaReview({
    ...
    notConfiguredMessage:
      "The Jared Friedman review is not available right now. Try again in a moment.",
  });
}

...
const TOOL_SLUG = "review-like-pete-koomen";

/** The free-tool id, which is also the backend agent id. */
const BACKEND_TOOL_ID = "review-like-pete-koomen";
...
export async function POST(request: NextRequest): Promise<Response> {
  return runPersonaReview({
    ...
    notConfiguredMessage:
      "The Pete Koomen review is not available right now. Try again in a moment.",
  });
}

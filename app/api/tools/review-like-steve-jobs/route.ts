...
const TOOL_SLUG = "review-like-steve-jobs";

/** The free-tool id, which is also the backend agent id. */
const BACKEND_TOOL_ID = "review-like-steve-jobs";
...
export async function POST(request: NextRequest): Promise<Response> {
  return runPersonaReview({
    ...
    notConfiguredMessage:
      "The Steve Jobs review is not available right now. Try again in a moment.",
  });
}

...
const TOOL_SLUG = "review-like-peter-thiel";

/** The free-tool id, which is also the backend agent id. */
const BACKEND_TOOL_ID = "review-like-peter-thiel";
...
export async function POST(request: NextRequest): Promise<Response> {
  return runPersonaReview({
    ...
    notConfiguredMessage:
      "The Peter Thiel review is not available right now. Try again in a moment.",
  });
}

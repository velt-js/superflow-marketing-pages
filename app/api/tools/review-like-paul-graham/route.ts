...
const TOOL_SLUG = "review-like-paul-graham";

/** The free-tool id, which is also the backend agent id. */
const BACKEND_TOOL_ID = "review-like-paul-graham";
...
export async function POST(request: NextRequest): Promise<Response> {
  return runPersonaReview({
    ...
    notConfiguredMessage:
      "The Paul Graham review is not available right now. Try again in a moment.",
  });
}

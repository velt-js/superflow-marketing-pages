// Gustaf Alströmer persona review.
//
...
const TOOL_SLUG = "review-like-gustaf-alstromer";

/** The free-tool id, which is also the backend agent id. */
const BACKEND_TOOL_ID = "review-like-gustaf-alstromer";
...
export async function POST(request: NextRequest): Promise<Response> {
  return runPersonaReview({
    ...
    notConfiguredMessage:
      "The Gustaf Alströmer review is not available right now. Try again in a moment.",
  });
}

...
import FaqSection, { FAQ_ITEMS } from "@/components/home-2026/FaqSection";
...
const PAGE_DESCRIPTION =
  "Paste your agency's QA checklist and AI agents review every site change. Your team and your client approve, no client login required. Free to start.";

// Preview route duplicates the live homepage, so keep it out of the index.
...
export default function HomePreviewPage() {
  return (
    <main>
      <PageJsonLd
        name="Watch AI Do Your QA Work | Superflow"
        description={PAGE_DESCRIPTION}
        path="/home-preview"
      />
      <JsonLd id="ld-software-application" data={SOFTWARE_APPLICATION_SCHEMA} />
      <JsonLd id="ld-faq-home-preview" data={FAQ_SCHEMA} />
      <SiteNav />
      <Hero />
      <ProblemSection />
      <SolutionSection />
